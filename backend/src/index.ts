...
app.use("*", logger());
// perizinan CORS untuk frontend yang berjalan di localhost:5173 dan jaringan lokal (192.168.111.*:5173)
app.use("*", cors({
  origin: ["http://localhost:5173", "http://192.168.111.*:5173"],
  // Atau pakai * jika testing saja (JANGAN di production!)
}));
